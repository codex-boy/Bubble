...
class Bubble {
  constructor() {
    ...
    // Attribution des hauteur et largeur des bulles
  ...
  // Création et apparition des bulles
  handleNewBubble() {
  ...
  handlePosition() {
    // Randomisation des positions des bulles sur X et Y
    ...
    setTimeout(this.handlePosition.bind(this), randomSec); // Repositionnement des bulles
  }
  ...
  // Ranndomisation des couleurs des bulles
  randomColor() {
    return `rgba(
...
// fréquence de création des bulles
